...
// import Experience from './Experience/Experience.js';
// // we are going to send the canvas as a parameter of the Experience class
// // when instantiation  in src/script.js use querySelector to send the canvas parameter
